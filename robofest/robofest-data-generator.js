...
const schemaConfigs = [
  ...
  {
    file: 'team-school-schema.json',
    name: 'Team School',
    count: 1000,
    sql: { enabled: true, tableName: 'team_school', batchSize: 100 }
  },
  {
    file: 'team-sponsors-schema.json',
    name: 'Team Sponsors',
    count: 4500,
    sql: { enabled: true, tableName: 'team_sponsors', batchSize: 500 }
  },
  {
    file: 'sponsor-contacts-schema.json',
    name: 'Sponsor Contacts',
    count: 1700,
    sql: { enabled: true, tableName: 'sponsor_contacts', batchSize: 500 }
  },
  {
    file: 'sponsor-donations-schema.json',
    name: 'Sponsor Donations',
    count: 5000,
    sql: { enabled: true, tableName: 'sponsor_donations', batchSize: 1000 }
  }
];
